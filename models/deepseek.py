...
from module.transformer.deepseek import DeepSeekTransformerBlock
...
class DeepSeek(nn.Module):
    def __init__(self,config):
        ...
        self.trf_blocks = nn.Sequential(*[DeepSeekTransformerBlock(config) for _ in range(config.n_layers)])
